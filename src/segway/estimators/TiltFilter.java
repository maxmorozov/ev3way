...
public class TiltFilter {
     ...
     * $Id: kalman_filter_tilt.c,v 1.1.1.1 2007/02/15 22:35:41 pcguest Exp $
     *
...
//static const float	dt	= (1.0/50);	// 50 hz
     ...
     */
    static final float R_angle = 0.3f * Constants.RAD_TO_DEGREE;
    /*
     * Q is a 2x2 matrix that represents the process covariance noise.
     * In this case, it indicates how much we trust the acceleromter
     * relative to the gyros.
     */
    static final float Q_angle = 0.001f * Constants.RAD_TO_DEGREE;
    static final float Q_gyro = 0.003f * Constants.RAD_TO_DEGREE;
    ...
    public void kalman_update(
         ...
         */
        //this variable was inlined (mm)
        //final float t_0 = PCt_0; /* C_0 * P[0][0] + C_1 * P[1][0] */
        final float t_1 = C_0 * P[0][1]; /* + C_1 * P[1][1]  = 0 */
